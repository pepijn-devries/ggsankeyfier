...
followed by alternatives.
  ...
  * Sankey diagram
    * *Alluvial diagram*. Although arguably not the same as a Sankey diagram,
      ...
      whereas Sankey diagrams are not necessarily structured, but the order does matter. See also
 ...
 * Piet GJ, Bentley JW, Jongbloed RH, Grundlehner A, Tamis JE, De Vries P (_in prep._)
