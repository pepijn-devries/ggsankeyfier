...
serves as proof of principle. With the \code{\link[ggplot2]{\%+\%}} operator we update the plot
...
can even let anedge flow from and to the same node. This is illustrated in the example
